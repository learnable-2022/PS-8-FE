    ...
    <div className="flex w-full justify-center">
      <div className="mt-8 w-[90%] ">
        ...
        {data.map((item) => (
          ...
          <p className="border-solid border-2 py-1 px-2 text-right text-xs">{item.performance}</p>
          <p className="font-bold text-black">is</p>
          <p className="border-solid border-2 py-1 px-1 text-xs">{item.perfvalue}</p>
          <p className="font-bold text-black ">Then Total Pay</p>
          <p className="font-bold text-black">=</p>
          <p className="border-solid border-2 py-1 px-1 text-xs">{item.percentage}</p>
          <p className="font-bold text-black">of</p>
          <p className="border-solid border-2 py-1 px-1 text-xs">{item.salary}</p>
        </div>
        ))}
