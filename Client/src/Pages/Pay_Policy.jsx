...
export const Pay_Policy = () => {
    ...
    <div className="flex w-full justify-center">
      <div className="mt-8 w-[90%] ">
        ...
        {data.map((item) => (
             <div key={item.id} className="flex items-center justify-start gap-6 border-black/20 bg-white py-[4px] rounded-lg border my-2 pl-[10%]">
          ...
          <p className="border-solid border-2 py-1 px-">{item.salary}</p>
        </div>
        ))}
